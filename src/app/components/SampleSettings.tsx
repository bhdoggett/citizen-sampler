...
const SampleSettings = ({ sampleId }) => {
  const { allSampleData, setAllSampleData, updateSamplerSettings } = useAudioContext();
  ...
  return (
    <div className="p-4">
      <h3 className="text-lg font-semibold mb-4">Editing Settings for {sample.title}</h3>
        ...
        <div className="flex flex-col">
          ...
          <label className="mb-2">
            ...
            <input
              ...
              onChange={(e) =>
                updateSetting("fx", "highpass", [parseFloat(e.target.value), "highpass"])
              }
              className="w-full"
            />
          </label>
          ...
          <label className="mb-2">
            ...
            <input
              ...
              onChange={(e) =>
                updateSetting("fx", "lowpass", [parseFloat(e.target.value), "lowpass"])
              }
              className="w-full"
            />
          </label>
