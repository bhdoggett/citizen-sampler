...
import SampleSettings from "../components/Audio/SampleSettings";
import DrumMachine from "../components/Audio/DrumMachine";
import PitchGrid from "../components/Audio/PitchGrid";
import { useUIContext } from "../contexts/UIContext";
import { useAudioContext } from "../contexts/AudioContext";
import ResendConfirmation from "../components/Dialogs/ResendConfirmation";
            ...
            <footer className="flex flex-col items-center mt-2 text-white">
              <p className="text-sm">
                ...
                <Link
                  ...
                  to="https://citizen-dj.labs.loc.gov/"
                >
                  Citizen DJ
                </Link>
              </p>
